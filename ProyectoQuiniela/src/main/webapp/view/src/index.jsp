    ...
    <div>
          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item">
              <a class='sidebar-link' href="forms.html">
                ...
                <span class="title">Formularioss</span>
              </a>
            </li>
      ...
      <div class="page-container">
        ...
        <footer class="bdT ta-c p-30 lh-0 fsz-sm c-grey-600">
          <span>Copyright EN 2017 Designed by <a href="https://colorlib.com" target='_blank' title="Colorlib">Colorlib</a>. All rights reserved.</span>
        </footer>
      </div>
    </div>
  </body>
